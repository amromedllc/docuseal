const en = {
  ...
  phone: 'Phone',
  voice: 'Voice',
  speak_or_type_here_: 'Speak or type here...',
  start_voice_input: 'Start voice input',
  stop_listening: 'Stop listening',
  listening_: 'Listening...',
  voice_input_not_supported: 'Voice input is not supported in this browser. You can still type your answer.',
  voice_summarize: 'Summarize',
  voice_summarizing: 'Summarizing...',
  voice_summary: 'Summary',
  voice_use_summary: 'Use summary',
  voice_summarize_failed: 'Unable to summarize text. Please try again.',
  start_now: 'Start Now',
  continue: 'Continue',
  sign_now: 'Sign Now',
